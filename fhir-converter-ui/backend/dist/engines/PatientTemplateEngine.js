...
exports.PatientTemplateEngine = void 0;
const BaseTemplateEngine_1 = require("./BaseTemplateEngine");
/**
 * Patient-specific template engine for detecting and scoring Patient resource templates
 */
class PatientTemplateEngine extends BaseTemplateEngine_1.BaseTemplateEngine {
    constructor() {
        super(...arguments);
    ...
    canHandle(jsonData) {
        ...
        const foundIndicators = patientIndicators.filter(indicator => structure.allFields.some(field => field.toLowerCase().includes(indicator.toLowerCase())));
...
exports.PatientTemplateEngine = PatientTemplateEngine;
